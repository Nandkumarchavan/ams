			...
			<div class="left-custom-menu-adp-wrap comment-scrollbar">
				<nav class="sidebar-nav left-sidebar-menu-pro">
					<ul class="metismenu" id="menu1">
						<li class="active"><a
							href="http://localhost:8081/leave/newuser.html"> <i
								class="icon nalika-home icon-wrap"></i> <span
								class="mini-click-non">Add Employee</span>
						</a></li>
						<li><a
							href="http://localhost:8081/leave/Attendance/attendance.jsp"
							aria-expanded="false"><i class="icon nalika-mail icon-wrap"></i>
								<span class="mini-click-non">Leave Track</span></a></li>
						<li><a
							href="http://localhost:8081/leave/Workdays/workdaysmain.jsp"
							aria-expanded="false"><i
								class="icon nalika-diamond icon-wrap"></i> <span
								class="mini-click-non">Workdays</span></a></li>
						<li><a
							href="http://localhost:8081/leave/Holidays/holidaysmaintenance.jsp"
							aria-expanded="false"><i
								class="icon nalika-pie-chart icon-wrap"></i> <span
								class="mini-click-non">Holidays</span></a></li>
						<li><a
							href="http://localhost:8081/leave/Attendance/Generate_Attendance.jsp"
							aria-expanded="false"><i class="icon nalika-forms icon-wrap"></i>
								<span class="mini-click-non">Generate Attendance</span></a></li>
						<li><a
							href="http://localhost:8081/leave/Attendance/viewAttendaceForm.jsp"
							aria-expanded="false"><i class="icon nalika-forms icon-wrap"></i>
								<span class="mini-click-non">View Attendance</span></a></li>
					</ul>
				</nav>
			</div>
		</nav>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
										<div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>Admin</h2>
												<p>
													Welcome to <span class="bread-ntd">Admin Page</span>
												</p>
											</div>
										</div>
									</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="product-status-wrap">
						...
						<table>
							...
							<tr>
								<td><img src="img/vaishnavi.jpg" alt="" /></td>
							...
							<tr>
								<td><img src="img/my_img.jpg" alt="" /></td>
